...
export default function NotifyOptIn({ nextCritical, title = "Risco alto de NO₂ chegando" }: Props) {
    ...
    timerRef.current = window.setTimeout(() => {
      try {
        new Notification(title, {
          body: `Risco alto previsto às ${when.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}.`,
        });
      } catch {}
