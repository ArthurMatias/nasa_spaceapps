...
export default function CitationPanel({ tempo }: Props) {
  if (!tempo) return null;
  const bbox = tempo.bbox_used
    ? `${tempo.bbox_used.minLon},${tempo.bbox_used.minLat},${tempo.bbox_used.maxLon},${tempo.bbox_used.maxLat}`
    : "—";
